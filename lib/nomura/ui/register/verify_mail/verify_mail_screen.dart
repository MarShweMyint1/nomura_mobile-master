...
class VerifyMailScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VerifyMailScreen> createState() =>
      _BiometricSettingsScreenContentState();
}

class _BiometricSettingsScreenContentState
    extends ConsumerState<VerifyMailScreen> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Spacer(),
                subtitleText(
                    'Please check your registered mail ${user.userData.email} and click on the verification link to continue with device enrollment.'),
                const Spacer(),
                const Spacer(),
              ],
            ),
