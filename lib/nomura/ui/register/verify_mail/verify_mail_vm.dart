...
import 'package:nomura_mobile/nomura/ui/register/verify_mail/verify_mail_screen.dart';
import 'package:nomura_mobile/nomura/ui/widgets/dialog_widget.dart';

class VerifyMailVM extends ConsumerWidget {
  const VerifyMailVM({super.key,});
  @override
