...
class VerifyCodeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VerifyCodeScreen> createState() => _VerifyCodeScreen();
}

class _VerifyCodeScreen extends ConsumerState<VerifyCodeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var counterresend = ref.watch(counterResendProvider);
